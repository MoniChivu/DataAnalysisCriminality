...
def correlogram(matrice=None, dec=1, titlu='Corelograma', valMin=-1, valMax=1):
...
def principalComponents(valoriProprii=None, titlu='Varianta explicata de componentele pricipale',
